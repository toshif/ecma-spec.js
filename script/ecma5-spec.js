 ...
 * @param {Object}
 *            descriptor - The descriptor for the property being defined or
 *            modified.
 * @returns {Object} obj
 * @since Standard ECMA-262 5th. Edition
 */
 ...
 * @param {Object}
 *            props - An object whose own enumerable properties constitute
 ...
 * @memberOf Object
 * @param {Object}
 *            obj - The object whose enumerable own properties are to be
 *            returned.
 * @returns {Array} keys -
 * @since Standard ECMA-262 5th. Edition
 */
 ...
 * it is non-extensible and if all its properties are non-configurable and
 ...
 * are not accessor properties with getter or setter components) are
 * non-writable.
 * </p>
 * 
 * @memberOf Object
 ...
 * them, and (in engines that support __proto__ Deprecated their __proto__
 ...
 * @param {Object}
 *            prop - The name of the property whose description is to be
 *            retrieved
 * @returns {Object}
 * @since Standard ECMA-262 5th. Edition
 */
 ...
 * @memberOf Object
 * @param {Object}
 *            obj - The object whose enumerable and non-enumerable own
 ...
 * <ul>
 * <li> previousValue - The value previously returned in the last invocation of
 * the callback, or initialValue, if supplied.
 ...
 * @memberOf Function
 * @param {Object}
 *            thisArg - The value to be passed as the this parameter to the
 *            target function when the bound function is called. The value is
 *            ignored if the bound function is constructed using the new
 *            operator.
 * @returns {Function}
 * @since Standard ECMA-262 5th. Edition
 */
